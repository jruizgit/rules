...
with ruleset('waltzdb'):
    ...
    def second_boundary_junction_l(c):
        ...
        c.assert_fact({'id': c.s.gid + 1, 't': 'edge_label', 'p1': c.j.base_point, 'p2': c.j.p1, 'label_name': 'B', 'lid': '1'})
        c.assert_fact({'id': c.s.gid + 2, 't': 'edge_label', 'p1': c.j.base_point, 'p2': c.j.p2, 'label_name': 'B', 'lid': '1'})
        c.assert_fact({'id': c.s.gid + 3, 't': 'stage', 'l': 'labeling'})
        c.s.gid += 4
        print('labeling')
    ...
    def second_boundary_junction_arrow(c):
        ...
        c.assert_fact({'id': c.s.gid + 2, 't': 'edge_label', 'p1': c.j.base_point, 'p2': c.j.p2, 'label_name': '+', 'lid': '14'})
        c.assert_fact({'id': c.s.gid + 3, 't': 'edge_label', 'p1': c.j.base_point, 'p2': c.j.p3, 'label_name': 'B', 'lid': '14'})
        c.assert_fact({'id': c.s.gid + 4, 't': 'stage', 'l': 'labeling'})
        c.s.gid += 5
        print('labeling')

    @when_all(cap(1000),
              c.j << (m.t == 'junction') & (m.j_t == '3j') & (m.visited == 'no'),
              (m.t == 'stage') & (m.l == 'labeling'))
    def start_visit_3_junction(c):
        print(len(c.m))
        for frame in c.m:
            c.retract_fact(frame.j); frame.j.id = c.s.gid; frame.j.visited = 'now'; c.assert_fact(frame.j) 
            c.s.gid += 1

        c.assert_fact({'id': c.s.gid, 't': 'stage', 'l': 'visiting_3j'})
        c.s.gid += 1
        print('visiting_3j')
    ...
    def start_visit_2_junction(c):
        ...
        c.assert_fact({'id': c.s.gid, 't': 'stage', 'l': 'visiting_2j'})
        c.s.gid += 1
        print('visiting_2j')
    ...
    def visit_3j(c):
        for frame in c.m:
            print('Edge Label {0} {1} {2} {3}'.format(frame.j.base_point, frame.j.p1, frame.l.n1, frame.l.lid))
            print('Edge Label {0} {1} {2} {3}'.format(frame.j.base_point, frame.j.p2, frame.l.n2, frame.l.lid))
            print('Edge Label {0} {1} {2} {3}'.format(frame.j.base_point, frame.j.p3, frame.l.n3, frame.l.lid))
            c.assert_fact({'id': c.s.gid, 't': 'edge_label', 'p1': frame.j.base_point, 'p2': frame.j.p1, 'label_name': frame.l.n1, 'lid': frame.l.lid})
            c.assert_fact({'id': c.s.gid + 1, 't': 'edge_label', 'p1': frame.j.base_point, 'p2': frame.j.p2, 'label_name': frame.l.n2, 'lid': frame.l.lid})
            c.assert_fact({'id': c.s.gid + 2, 't': 'edge_label', 'p1': frame.j.base_point, 'p2': frame.j.p3, 'label_name': frame.l.n3, 'lid': frame.l.lid})
            c.s.gid += 3

    @when_all(cap(10),
              c.j << (m.t == 'junction') & (m.visited == 'now') & (m.j_t == '3j'),
              c.l << (m.t == 'label') & (m.name == c.j.name) & (m.j_t == '3j'), 
    ...
    @when_all(cap(10),
              c.j << (m.t == 'junction') & (m.visited == 'now') & (m.j_t == '2j'),
              c.l << (m.t == 'label') & (m.name == c.j.name) & (m.j_t == '2j'), 
              c.el1 << (m.t == 'edge_label') & (m.p1 == c.j.p1) & (m.p2 == c.j.base_point) & (m.label_name == c.l.n1),
              c.el2 << (m.t == 'edge_label') & (m.p1 == c.j.p2) & (m.p2 == c.j.base_point) & (m.label_name == c.l.n2),
              none((m.t == 'edge_label') & (m.p1 == c.j.base_point) & (m.lid == c.l.lid)),
    ...
    def marking(c):
        for frame in c.m:
            c.retract_fact(frame.junction); frame.junction.id = c.s.gid; frame.junction.visited = 'check'; c.assert_fact(frame.junction) 
            c.s.gid += 1
    ...
    def stop_marking(c):
        for frame in c.m:
            c.retract_fact(frame.j); frame.j.id = c.s.gid; frame.j.visited = 'yes'; c.assert_fact(frame.j) 
            c.s.gid += 1
    ...
    @when_all(cap(1000),
              c.junction << (m.t == 'junction') & (m.visited == 'check'),
    ...
    def checking(c):
        for frame in c.m:
            c.assert_fact({'id': c.s.gid, 't': 'illegal', 'base_point': frame.junction.base_point, 'lid': frame.el1.lid})
            c.s.gid += 1

        print('remove_label')
        c.retract_fact(c.m[0].stage)
        c.assert_fact({'id': c.s.gid, 't': 'stage', 'l': 'remove_label'})
        c.s.gid += 1
    ...
    def stop_checking(c):
        c.retract_fact(c.stage)
        c.assert_fact({'id': c.s.gid, 't': 'stage', 'l': 'labeling'})
        c.s.gid += 1
        print('labeling')
    ...
    def remove_label_3j(c):
        for frame in c.m:
            c.retract_fact(frame.i)
            c.retract_fact(frame.el1)
            c.retract_fact(frame.el2)
            c.retract_fact(frame.el3)

...
"    return message\n"
"end\n"
"local validate_frame_for_key = function(frame, index, events_key, messages_key, message_cache)\n"
...
"    local first_result = validate_frame_for_key(frame, index, keys[index] .. \"!e!\" .. sid, events_hashset, events_message_cache)\n"
"    local second_result = validate_frame_for_key(frame, index, keys[index] ..\"!f!\" .. sid, facts_hashset, facts_message_cache)\n"
...
"        if string.sub(name, 1, 3) == \"$n:\" then\n"
"            table.insert(indexes, tonumber(string.sub(name, 4)))\n"
"        elseif name ~= \"$f\" then\n"
...
"        end\n"
"    end\n"
"    redis.call(\"lpush\", frames_key, cmsgpack.pack(frame_to_pack))\n"
"end\n"
"local save_result = function(frame)\n"
"    if assert_fact == 1 then\n"
"        frame[\"$f\"] = 1\n"
"    end\n"
"    table.insert(results, cmsgpack.pack(frame))\n"
"    for name, message in pairs(frame) do\n"
...
"            if message then\n"
"                redis.call(\"lpush\", events_key, new_mid)\n"
"                if not reviewers[index](message, new_frame, index) then\n"
"                    result = 0\n"
"                    break\n"
"                end\n"
"            end\n"
...
"                table.insert(indexes, tonumber(string.sub(name, 4)))\n"
"                frame[name] = nil\n"
"            elseif message[\"$f\"] ~= 1 then\n"
"                table.insert(events_to_cancel, message)\n"
"            elseif not facts_message_cache[message[\"id\"]] and redis.call(\"hexists\", facts_hashset, message[\"id\"]) == 0 then\n"
"                result = false\n"
"            else\n"
"                facts_message_cache[message[\"id\"]] = message\n"
"                message[\"$f\"] = nil\n"
"            end\n"
"        end\n"

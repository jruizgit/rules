...
"end\n"
"local review_frame = function(packed_frame, rule_action_key, sid, max_score)\n"
...
"        for i = 1, #frame, 1 do\n"
"            if frame[i] == \"$n\" then\n"
"                if not validate_frame(packed_frame, full_frame, i, sid) then\n"
"                    cancel = true\n"
"                    break\n"
"                end\n"
"            end\n"
...
"            break\n"
"        else\n"
"            local frame = review_frame(packed_frame, rule_action_key, sid, max_score)\n"
"            if frame then\n"

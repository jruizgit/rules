...
if (cluster.isMaster) {
    ...
    // var handle = getRuleset('books', chargeRules);
    // console.log('Start books positive 1: ' + new Date());
    ...
    // console.log('End books positive 1: ' + new Date());

    // var handle = getRuleset('books', chargeRules);
    // console.log('Start books positive 10: ' + new Date());

    // for (var m = 0; m < 3600; ++m) {
    //     for (var i = 0; i < 16; ++i) {
    //         r.assertEvent(handle, 
    //             JSON.stringify({
    //                 id: m + '_' + i,
    ...
    // console.log('End books positive 10: ' + new Date());

    // var handle = getRuleset('books', chargeRules);
    // console.log('Start books positive 20: ' + new Date());
    ...
    // console.log('End books positive 20: ' + new Date());

    // var handle = getRuleset('books', chargeRules);
    // console.log('Start books positive 40: ' + new Date());
    ...
    // console.log('End books positive 40: ' + new Date());

    var handle = getRuleset('books', chargeRules);
    console.log('Start books positive 80: ' + new Date());
    ...
    console.log('End books positive 80: ' + new Date());

...
console.log(r.getState(handle, 1));
...
console.log(r.getState(handle, 2));
...
console.log(r.getState(handle, 3));
...
console.log(r.getState(handle, 4));
...
console.log(r.getState(handle, 5));
